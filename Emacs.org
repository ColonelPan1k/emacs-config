...
#+END_SRC
*** Elpy
Get Elpy working so I'm not writing python in 1967
...
*** Auto-Complete
** TypeScript
Setup basic config for typescript files, auto-format and lint files on save
#+begin_src emacs-lisp
...
** Scheme
** Vue
Open all =.vue= files in web-mode by default
#+begin_src emacs-lisp
...
org-indent is kind of annoying and just gets in the way, I'd rather not have it
#+begin_src emacs-lisp
