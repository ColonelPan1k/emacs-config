* Startup
** Speed up init times
Don't know if this really does improve startup times but it can't hurt right?

Set garbage collection threshold
#+begin_src emacs-lisp
  (setq gc-cons-threhshold-original gc-cons-threshold)
  (setq gc-cons-thresold (* 1024 1024 100))
#+end_src
...
(use-package electric-operator
  :hook ((python-mode sql-mode) . electric-operator-mode))
#+end_src
...
(setq-default c-electic-brace nil)
(add-to-list 'auto-mode-alist '("\\.c\\'" . ccls))
